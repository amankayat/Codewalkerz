...
<body>
  ...
  <div>
    <nav class="navbar navbar-expand-lg navbar navbar-expand-sm fixed-top navbar-dark bg-dark">
      ...
      <a class="navbar-brand ml-3 " href="https://www.scanitjsr.org/" style="font-weight:bolder ;font-size:30px"
      ...
      <div class="collapse navbar-collapse sticky-top" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto justify-content-center">
          ...
          <li class="nav-item ">
            <a class="nav-link  " href="codewalkerz.php">Home </a>
          </li>
  ...
  <!--<div class="wrap">-->
  <!-- <a style="list-style-type: none ; color:black;" href="#register"> <button class="button button1">Register here!</button></a>-->
  <!--</div>-->
  <!--<div class="wrap">-->
  ...
  <!--</div>-->
         ...
         <div class="  row mb-5">
    <div class="col-sm-6  flex d-flex justify-content-center">
    <a href="#register" class="" style="text-decoration:none; color:white;"><div class="outer">  Snap the Quest! (Register) </div></a>
    </div>
    <div class="col-sm-6   flex d-flex justify-content-center">
    <a href="http://bit.ly/42mMTgR" class="" style="text-decoration:none; color:white;" target="__blank"><div class="outer">  Coding Event (Register) </div></a>
  ...
  data-aos-easing="ease-in-out" data-aos-mirror="true">
    ...
    <div class="row justify-content-md-center">
      <div class="col-md-10">
        ...
        <div class="detail part" style="color: #11999e;"><span id="value">2000</span>+</div>
        ...
        <div class="text-center">
          ...
          <div class="col-md-6">
            <h3 class="text-center text-dark mb-4 "> <b>Associated With</b> </h3>
        <div class="text-center">
          ...
          <div class="container">
            <div class="">
              ...
              <div class="row mt-5">
                <div class="col-md-8 ">
                  <div class="">
                    <h3>CRACK THE BINGES &nbsp;&nbsp;<span style="color:red;">((&nbsp;Elimination Round I&nbsp;))</span></h3>
                  </div>
                  <br>
                  <div>
              ...
              <div class="row mt-3">
                <div class="col-md-8 ">
                  <div >
                    <h3 >Dig The Riddle &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red;">((&nbsp;Elimination Round II&nbsp;))</span></h3>
                  </div>
                  <br>
                  <div>
              ...
              <div class="row mt-3">
                <div class="col-md-8 ">
                  <div>
                    <h3>BEG! BORROW! STEAL! &nbsp;&nbsp;<span style="color:rgb(54, 224, 54);;">((&nbsp;The Final Stage&nbsp;))</span></h3>
                  </div>
                  <br>
                  <div>
  ...
  <div class="container" id="prizes" >
    ...
    exclusive
              ...
              <h2 class="text-center text-dark">Codewalkerz T-shirt</h2>
              <div class="text-center mt-3">
                <img src="images/codeblock.jpg" alt="">
              </div>
      </div>
              ...
              <div class="card-body p-md-5">
                ...
                <form class="px-md-2" id="reg-form" method="post" action="register.php">
                  ...
                  <div style="color:red; margin-top:10px;">
                    <h3>~ RULES ~</h3>
                    <ul>
                      <li style="text-transform:uppercase;"><b>Snap the Quest</b> will be held in teams comprising of 3/4 members.</li>
                      <li>Form must be filled by all the members.</li>
                      <li>Team names will be assigned on the spot on the event day.</li>
                      <li style="text-transform:uppercase;"><b>If someone is not capable of forming a team of atlaest 3 peers, then he/she will be assigned a team discreatly on the spot of the event.</b></li>
                    </ul>
                  </div>
                </form>
                <!-- </div> -->
